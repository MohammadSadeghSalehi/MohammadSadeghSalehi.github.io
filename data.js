const SITE_DATA = {
    ...
    "biography":  "<p>I am a researcher and engineer working at the intersection of computer vision, generative 3D, 3D modelling, generative models, optimisation, inverse problems, and machine learning. My work spans both academic research and industrial R&amp;D, with a focus on developing algorithms for hyperparameter learning, 3D modelling, vision-language models, diffusion models, and test-time adaptation.\n\nI currently work on generative 3D and AI systems at <a href=\"https://amara.01c.ai/\" target=\"_blank\">Zero One Creative</a>, contributing to the development of Amara, an AI platform designed to generate and iterate full 3D environments from simple prompts for creative and production workflows.\n\nI did PhD studies and hold an MRes in Statistical Applied Mathematics, where I was supervised by Dr. Matthias Ehrhardt and Dr. Subhadip Mukherjee. Previously, I earned an MSc in Applied and Theoretical Mathematics from PSL Research University in Paris. My research interests continue to centre on vision, generative models, optimisation, inverse problems, and the bridge between rigorous mathematical methods and practical large-scale visual systems.</p>",
    "interests":  [
                      "Generative Models",
                      "Computer Vision",
                      "Optimisation",
